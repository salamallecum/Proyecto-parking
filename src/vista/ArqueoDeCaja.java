...
public class ArqueoDeCaja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_finalizar.setBounds(308, 244, 125, 43);
    ...
    private void btn_finalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_finalizarActionPerformed
        ...
        if(numBilletesDe100Mil.equals("") || numBilletesDe50Mil.equals("") || numBilletesDe20Mil.equals("") || 
            ...
            while(ventanaEmergCopiaArqueo == true){
               ...
               int eleccionFinalizarArqueo = JOptionPane.showOptionDialog(this, "Arqueo de caja finalizado satisfactoriamente.", "Arqueo de caja", 0, JOptionPane.INFORMATION_MESSAGE, paramControla.getIcon("/icons/exitoso.png", 32, 32), botones, this);
    ...
    private void cerrarArqueoDeCaja(){
        ...
        int eleccion = JOptionPane.showOptionDialog(this, "¿Está seguro que desea cerrar?", "Arqueo de caja", 0, JOptionPane.QUESTION_MESSAGE, paramControla.getIcon("/icons/pregunta.png", 32, 32), botones, this);
